 ...
 */
export type VideoConvertOptions = { "kind": "copy" } | { "kind": "encode", codec: VideoCodec, rate_control: VideoRateControl, speed: VideoSpeed, processor: VideoProcessor, resize?: VideoResize | null, frame_rate?: VideoFrameRate | null, };
