...
export type JobResult = { source_bytes?: bigint | null, target_bytes?: bigint | null, reencoded?: boolean | null, output_path: string | null, bytes: bigint | null, duration_ms: bigint, 
/**
